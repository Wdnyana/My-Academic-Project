...
const AddCategoryModal = (props) => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="rounded-5 ms-start-5 position-relative bg-secondary w-12/12 md:w-3/6 shadow-lg d-flex flex-column align-items-center my-4 overflow-y-auto px-4 py-4 px-md-5">
          <div className="d-flex align-items-center justify-content-between w-full pt-4">
            ...
            <span
              ...
              className="cursor-pointer text-secondary py-2 px-2 rounded-5"
            >
              <svg
