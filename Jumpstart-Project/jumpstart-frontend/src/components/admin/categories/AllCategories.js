...
const AllCategory = (props) => {
  ...
  return (
    <Fragment>
      <div className="col-span-1 overflow-auto shadow-lg p-4">
          ...
          <tbody>
            {categories && categories.length > 0 ? (
              ...
              <tr>
                <td
                  colSpan="7"
                  className="text-xl text-center fw-semibold py-5"
                >
                  No category found
                </td>
              </tr>
      ...
      <tr>
        ...
        <td className=" p-2 text-center">
          {category.cStatus === "Active" ? (
            <span className="bg-success rounded-5 text-center text-xs px-3 py-2 fw-semibold">
              {category.cStatus}
            </span>
          ) : (
            <span className="bg-red-200 rounded-5 text-center text-xs px-3 py-2 fw-semibold">
              {category.cStatus}
            </span>
          )}
        </td>
