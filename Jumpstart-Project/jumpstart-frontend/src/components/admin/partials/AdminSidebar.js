...
const AdminSidebar = (props) => {
  ...
  return (
    <Fragment>
      <div
        id="sidebar"
        className="d-none d-md-block p-5 sticky-top top-0 left-0 h-screen md:w-3/12 lg:w-2/12 sidebarShadow bg-secondary text-light"
      >
        <div
          onClick={(e) => history.push("/admin/dashboard")}
          className={`${
            location.pathname === "/admin/dashboard" ? " bg-secondary" : ""
          }  cursor-pointer d-flex flex-column align-items-center justify-content-center py-4`}
        >
          <span>
            <svg
        ...
        >
          ...
          <span className="text-light">Order</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
