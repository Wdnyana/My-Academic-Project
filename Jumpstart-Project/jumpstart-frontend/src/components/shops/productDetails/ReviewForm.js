...
const ReviewForm = (props) => {
  ...
  return (
    <Fragment>
      <div className="container bg-secondary pb-5">
        ...
        {ratingUserList.includes(isAuthenticate().user._id) ? (
          ...
          <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 d-flex flex-column">
            <div className="d-flex flex-column my-2">
              <span className="text-2xl fw-semibold">Add a review</span>
            ...
            <div className="mt-2">
              <div className="d-flex flex-column">
                <label htmlFor="textArea" className="mb-3">
                  Review <span className="text-sm text-light">*</span>
                </label>
                <textarea
                  onChange={(e) =>
                  ...
                  value={fData.review}
                  className="border px-4 py-2 focus:outline-none bg-transparent text-light px-4 py-3 rounded-4"
                  name="textArea"
                  id="textArea"
                  cols={30}
                  rows={3}
              ...
              <div
                ...
                className="bg-primary fw-semibold rounded-5 px-4 py-2 mt-4 text-white text-center cursor-pointer"
              >
                Submit
              </div>
            </div>
